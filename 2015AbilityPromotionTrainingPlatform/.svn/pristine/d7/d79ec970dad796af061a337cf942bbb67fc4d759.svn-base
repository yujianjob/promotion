...
{
	public class Member_TrainingReditBLL
	{
		Member_TrainingReditDAL dal = new Member_TrainingReditDAL();
		...
		/// <returns></returns>
		public bool Add(Member_TrainingRedit model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Member_TrainingRedit model)
		{
