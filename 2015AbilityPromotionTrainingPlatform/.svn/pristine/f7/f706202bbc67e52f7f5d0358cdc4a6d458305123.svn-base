...
{
	public class PlatformManager_DetailBLL
	{
		PlatformManager_DetailDAL dal = new PlatformManager_DetailDAL();
		...
		/// <returns></returns>
		public bool Add(PlatformManager_Detail model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(PlatformManager_Detail model)
		{
