$(function () {
    $proto.init(function () {
        ...
        if (FinalTestLimit == "True") {
            //$("#radioFinalTestLimit").attr("checked", "checked");
            //$("#radioNotDisplay").removeAttr("checked");
            $("#radioFinalTestLimit").click();
        }
        else {
            //$("#radioFinalTestLimit").removeAttr("checked");
            //$("#radioNotDisplay").attr("checked", "checked");
            $("#radioNotDisplay").click();
        }
        ...
        $('#btnSubmit').click(function () {
            ...
            if (IsActivityEditRename(UnitId, 6, Trim(HtmlEncode($("#txtTitle").val())), Id)) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    location.href = "/Course/CourseCreate/CourseActivityExamQues?TrainingId=" + UrlEncode(TrainingId) + "&UnitContent=" + UrlEncode(Id);
                },
                error: function () {
                }
            });
