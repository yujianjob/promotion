...
{
	public class Member_ClassContentNoteBLL
	{
		Member_ClassContentNoteDAL dal = new Member_ClassContentNoteDAL();
		...
		/// <returns></returns>
		public bool Add(Member_ClassContentNote model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Member_ClassContentNote model)
		{
        ...
        {
            return dal.GetMemberClassContentNoteCount(where);
        }
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public bool Delete(Member_ClassContentNote model)
        {
        ...
        {
            return dal.GetNotesInfoById(Id);
        }
    }
}
