...
namespace Dianda.AP.DAL
{
	public partial class Course_UnitContentDAL
	{
        ...
        {
            string sql = @"select A.id as id,A.title as title,A.content as content,unittype,timelength,A.display as display,(case when OpenTime=0 then 0 else dateadd(DAY,OpenTime,OpenClassFrom) end) as OpenDate,(case when EndTime=0 then 0 else dateadd(DAY,EndTime,OpenClassFrom) end) as EndDate,D.Status as Status   
