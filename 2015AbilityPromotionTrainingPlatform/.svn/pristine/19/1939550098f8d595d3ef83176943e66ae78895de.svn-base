$(function () {
    $proto.init(function () {
        ...
        $("#UnitId").change(function () {
            GetUnitContentMaxOrder($("#UnitId").val(), 6);
        });
        ...
        $('#btnSubmit').click(function () {
            ...
            if (IsActivityAddRename($("#UnitId").val(), 6, Trim(HtmlEncode($("#txtTitle").val())))) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    location.href = "/Course/CourseCreate/CourseActivityExamQues?TrainingId=" + UrlEncode(TrainingId) + "&UnitContent=" + UrlEncode(data.UnitContent);
                },
                error: function () {
                }
            });
