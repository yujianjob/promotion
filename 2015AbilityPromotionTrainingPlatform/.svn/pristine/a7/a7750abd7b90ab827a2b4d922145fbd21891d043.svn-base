$(function () {
    $proto.init(function () {
        ...
        $('#btnAdd').click(function () {
            ...
            var obj = JSON.stringify({ UnitContent: UnitContent, QTtype: $("#ddlQuesType").val(), Content: HtmlEncode($("#txtContent").val()), Question: Question, Answer: Answer, Credit: $("#txtCredit").val() });
            $.ajax({
                cache: false,
                async: false,
                type: 'post',
                contentType: 'application/json',
                url: '/CourseCreate/AddQuizQues',
                data: obj,
                dataType: 'json',
        ...
        $('#btnEdit').click(function () {
            ...
            var obj = JSON.stringify({ Id: $("#TestId").val(), QTtype: $("#ddlQuesType").val(), Content: HtmlEncode($("#txtContent").val()), Question: Question, Answer: Answer, Credit: $("#txtCredit").val() });
            $.ajax({
                cache: false,
                async: false,
                type: 'post',
                contentType: 'application/json',
                url: '/CourseCreate/EditUnitQuestion',
                data: obj,
                dataType: 'json',
                success: function (data) {
                    Alert(data.Msg);
...
function showQuesList() {
    ...
    var obj = JSON.stringify({ UnitContent: UnitContent });
    $.ajax({
        cache: false,
        async: false,
        type: 'post',
        contentType: 'application/json',
        url: '/CourseCreate/QuizQuesInfo',
        data: obj,
        dataType: 'json',
        success: function (data) {
...
function EditQuesDetail(obj, id) {
    ...
    $.ajax({
        ...
        type: 'post',
        contentType: 'application/json',
        url: '/CourseCreate/QuizQuesModel',
        data: obj,
        dataType: 'json',
        success: function (data) {
            if (!data || !data.Data || data.Data.length == 0) {
...
function DeleteUnitTest() {
    ...
    if (returnVal) {
        ...
        $.ajax({
            ...
            type: 'post',
            contentType: 'application/json',
            url: '/CourseCreate/DeleteUnitQuestion',
            data: obj,
            dataType: 'json',
            success: function (data) {
                Alert(data.Msg);
...
function SetVerson() {
    ...
    $.ajax({
        ...
        type: 'post',
        contentType: 'application/json',
        url: '/CourseCreate/SetQuizVerson',
        data: obj,
        dataType: 'json',
        success: function (data) {
