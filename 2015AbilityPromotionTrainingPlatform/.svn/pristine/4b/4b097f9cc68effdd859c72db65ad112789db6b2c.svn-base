...
{
	public class Member_WorkRankBLL
	{
		Member_WorkRankDAL dal = new Member_WorkRankDAL();
		...
		/// <returns></returns>
		public bool Add(Member_WorkRank model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Member_WorkRank model)
		{
