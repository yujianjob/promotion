...
{
	public class Member_ClassContentTimeRecordBLL
	{
		Member_ClassContentTimeRecordDAL dal = new Member_ClassContentTimeRecordDAL();
		...
		/// <returns></returns>
		public bool Add(Member_ClassContentTimeRecord model)
		{
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public int AddRecord(Member_ClassContentTimeRecord model)
        {
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Member_ClassContentTimeRecord model)
		{
