...
{
	public class PlatformManager_RoleBLL
	{
		PlatformManager_RoleDAL dal = new PlatformManager_RoleDAL();
		...
		/// <returns></returns>
		public bool Add(PlatformManager_Role model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(PlatformManager_Role model)
		{
