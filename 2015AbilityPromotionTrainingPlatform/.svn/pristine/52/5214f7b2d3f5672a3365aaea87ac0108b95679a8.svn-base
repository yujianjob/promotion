...
namespace Dianda.AP.DAL
{
    public class PeriodDAL
    {
        ...
        public DataTable GetList(int pageSize, int pageIndex, string where, string orderBy, out int recordCount)
        {
            ...
            DataTable dt = MSEntLibSqlHelper.ExecuteDataSetBySql(sql.ToString(),para).Tables[0];
            return dt;
        }
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append(" select d.Title as FidTitle,b.Title as DetailTitle,b.TotalTime as Credits, b.CreateDate ");
            ...
            StringBuilder sb = new StringBuilder();
            sb.Append(" select '实践应用课程' as FidTitle,b.Title as DetailTitle,sum(c.Credits) as Credits,a.CreateDate  ");
