...
{
	public class NationalAbility_SCourseFieldInCourseBLL
	{
		NationalAbility_SCourseFieldInCourseDAL dal = new NationalAbility_SCourseFieldInCourseDAL();
		...
		/// <returns></returns>
		public bool Add(NationalAbility_SCourseFieldInCourse model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(NationalAbility_SCourseFieldInCourse model)
		{
