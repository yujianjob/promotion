...
(function(){
  ...
  var _videoDefaultWidth = 510;
  var _videoDefaultHeight = 340;
        ...
        for(var i=0,img; img=imgs[i++];){
            if(img.getAttribute("selected")){
                videoObjs.push({
                    ...
                    width:_videoDefaultWidth,
                    height:_videoDefaultHeight,
                    align:"none"
                });
            }
        }
    ...
    function insertUpload(){
        var videoObjs=[],
            ...
            width = $G('upload_width').value || _videoDefaultWidth,
            height = $G('upload_height').value || _videoDefaultHeight,
