...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'edittable':'表格属性','edittd':'单元格属性', 'link':'内部元素添加','emotion':'表情', 'spechars':'特殊字符', 'searchreplace':'查询替换', 'map':'Baidu地图', 'gmap':'Google地图',
    ...
    'link':{
        'static':{
            ...
            'lang_input_url':'元素链接地址：',
            'lang_input_title':'标题：',
            'lang_input_target':'是否在新窗口打开：'
        },
        'validLink':'只支持选中一个链接时生效',
        'httpPrompt':'您输入的内部元素中不包含http等协议名称，默认将为您添加http://前缀系统将识别之后添加到乐享内容中'
        //'httpPrompt': '您输入的正确的内部元素，例如： act.shlll.net··，'
    },
    'map':{
        'static':{
            lang_city:"城市",
