...
public class fileUp : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        //string[] filetype = { ".rar", ".zip", ".pdf", ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".txt", ".swf", ".mkv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg", ".ogg", ".mov", ".wmv", ".mp4", ".webm", "exe" };    //文件允许格式
        string[] filetype = { ".rar", ".zip", ".pdf", ".doc", ".docx", ".xls", ".xlsx", ".ppt"};    //文件允许格式
        ...
        info = up.upFile1(context, pathbase,  filetype, size); //获取上传状态
