$(function () {
    $proto.init(function () {
        ...
        $("#UnitId").change(function () {
            GetUnitContentMaxOrder($("#UnitId").val(), 3);
        });
        ...
        $('#btnSubmit').click(function () {
            ...
            if (IsActivityAddRename($("#UnitId").val(), 3, Trim(HtmlEncode($("#txtTitle").val())))) {
            ...
            var obj = JSON.stringify({ UnitId: $("#UnitId").val(), Title: HtmlEncode($("#txtTitle").val()), Sort: $("#txtSort").val(), TimeLength: $("#txtTimeLength").val(), Content: HtmlEncode($("#areaContent").val()), OpenTime: ($("#radioPartialOpen").is(":checked") ? $("#txtAfterOpenDayNum").val() : 0), EndTime: ($("#radioPartialEnd").is(":checked") ? $("#txtAfterEndDayNum").val() : 0), UnitType: 3 });
            $.ajax({
                cache: false,
                type: 'post',
