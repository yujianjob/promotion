(function (a) {
...
})(jwplayer.html5.parsers); (function (b) {
...
})(jwplayer.html5.parsers); (function (g) {
    var b = jwplayer.utils,
    a = g.textContent,
    e = g.getChildNode,
    f = g.numChildren,
...
})(jwplayer.html5.parsers); (function (a) {
    a.srt = function (g, b) {
        var d, c, j = jwplayer.utils.seconds;
        function h(l) {
            if (l == 0) {
...
})(jwplayer.html5.parsers); (function (e) {
    ...
    m.controlbar = function (ai, aW) {
        ...
        function bx() {
            aH = z.extend({},
            J, Y.getComponentSettings("controlbar"), aW);
    ...
    c.controller = function (j, k) {
        ...
        function Q() {
            ...
            o.addEventListener(e.JWPLAYER_MEDIA_COMPLETE,
            function (U) {
                setTimeout(G, 25)
            })
        }
        ...
        function S(V) {
            ...
            U.addEventListener(e.JWPLAYER_PLAYLIST_LOADED,
            function (W) {
                O(W.playlist)
            });
            U.addEventListener(e.JWPLAYER_ERROR,
            function (W) {
                O([]);
    ...
    e.overlay = function (H, K, E) {
        ...
        J, N, M = E,
        v = r.extend({},
        o, B.getComponentSettings("tooltip")),
        z = {},
        L = this;
        function D() {
            C = O(l.replace(".", ""));
    ...
    g.playlistcomponent = function (I, T) {
        ...
        B = N.skin,
        s = o.extend({},
        f, N.skin.getComponentSettings("playlist"), T),
        O,
        C,
        r,
        w,
    ...
    l.view = function (N, I) {
        ...
        an, Z, X, au, D = 0,
        aF = 2000,
        F, aO, S, aE, aP, aA, aq, aw = x.extend({},
        ...
        function C() {
            var aU = K.width,
            aS = K.height,
            aV = K.componentConfig("controlbar"),
            aT = K.componentConfig("display");
            G(aS);
        ...
        function aj(aU, aS) {
            ...
            var aW = K.playlistsize,
            aX = K.playlistposition;
        ...
        this.getSafeRegion = function () {
            ...
            a0 = x.bounds(Z),
            aU = a0.top,
            aX = x.bounds(aE.element()),
            aT = (aA.numButtons() > 0),
            aW = x.bounds(aA.element()),
            aV = x.bounds(aq.element()),
            aY = (aq.position().indexOf("top") == 0),
            aS = {};
            aS.x = 0;
