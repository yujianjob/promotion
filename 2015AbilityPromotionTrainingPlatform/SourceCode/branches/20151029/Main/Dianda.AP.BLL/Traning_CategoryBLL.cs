...
{
	public class Traning_CategoryBLL
	{
		Traning_CategoryDAL dal = new Traning_CategoryDAL();
		...
		/// <returns></returns>
		public bool Add(Traning_Category model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Traning_Category model)
		{
