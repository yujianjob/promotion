...
{
	public class Member_StudySectionBLL
	{
		Member_StudySectionDAL dal = new Member_StudySectionDAL();
		...
		/// <returns></returns>
		public bool Add(Member_StudySection model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Member_StudySection model)
		{
