...
{
	public class PracticalCourse_RoleBLL
	{
		PracticalCourse_RoleDAL dal = new PracticalCourse_RoleDAL();
		...
		/// <returns></returns>
		public bool Add(PracticalCourse_Role model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(PracticalCourse_Role model)
		{
		...
		{
            return dal.GetRoleListByTopic(where, orderBy);
		}
