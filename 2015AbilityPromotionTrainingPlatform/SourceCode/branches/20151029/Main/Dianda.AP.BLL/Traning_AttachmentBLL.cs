...
{
	public class Traning_AttachmentBLL
	{
		Traning_AttachmentDAL dal = new Traning_AttachmentDAL();
		...
		/// <returns></returns>
		public bool Add(Traning_Attachment model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Traning_Attachment model)
		{
