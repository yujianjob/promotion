...
{
	public class PracticalCourse_RoleCreditsBLL
	{
		PracticalCourse_RoleCreditsDAL dal = new PracticalCourse_RoleCreditsDAL();
		...
		/// <returns></returns>
		public bool Add(PracticalCourse_RoleCredits model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(PracticalCourse_RoleCredits model)
		{
