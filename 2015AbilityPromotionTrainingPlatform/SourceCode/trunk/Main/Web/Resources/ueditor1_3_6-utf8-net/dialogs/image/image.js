...
(function () {
    ...
    function insertSingle() {
        ...
        imgObj.height = height.value; //TLM
    ...
    function insertBatch() {
        ...
        for (var i = 0, ci; ci = imageUrls[i++];) {
            ...
            //TLM测试，先强制存放小图看看小图效果
           // tmpObj._src = tmpObj.src = editor.options.imagePath + 'File/Activity/ActivityAtt/2014/6/23/S/201406231535590864.jpg';
            imgObjs.push(tmpObj);
        }
        insertImage(imgObjs);
        hideFlash();
