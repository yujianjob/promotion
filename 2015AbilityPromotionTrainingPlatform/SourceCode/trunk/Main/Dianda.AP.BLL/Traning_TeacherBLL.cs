...
{
	public class Traning_TeacherBLL
	{
		Traning_TeacherDAL dal = new Traning_TeacherDAL();
		...
		/// <returns></returns>
		public bool Add(Traning_Teacher model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Traning_Teacher model)
		{
