...
{
	public class Member_ClassCommentBLL
	{
		Member_ClassCommentDAL dal = new Member_ClassCommentDAL();
		...
		/// <returns></returns>
		public bool Add(Member_ClassComment model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Member_ClassComment model)
		{
