...
{
	public class Organ_StudyRegionBLL
	{
		Organ_StudyRegionDAL dal = new Organ_StudyRegionDAL();
		...
		/// <returns></returns>
		public bool Add(Organ_StudyRegion model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Organ_StudyRegion model)
		{
