...
{
	public class Traning_OutCourseTypeBLL
	{
		Traning_OutCourseTypeDAL dal = new Traning_OutCourseTypeDAL();
		...
		/// <returns></returns>
		public bool Add(Traning_OutCourseType model)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		public bool Update(Traning_OutCourseType model)
		{
